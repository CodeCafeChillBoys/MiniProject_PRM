...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _startRace() {
    ...
    if (currentTotalBet > totalMoney) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Tổng cược không được vượt quá số tiền hiện có!')),
      );
      return;
    }
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => RaceScreen(racers: racers, totalMoney: totalMoney),
      ),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('PRO RACER', style: TextStyle(fontWeight: FontWeight.bold)),
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  const Icon(Icons.account_balance_wallet, size: 28, color: Colors.deepOrange),
                ...
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        children: [
                          Image.asset(racer.assetPath, width: 80, height: 50, fit: BoxFit.contain),
                          const SizedBox(width: 16),
                          Expanded(
                            child: Text(racer.name, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                          ),
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      color: _totalBet > totalMoney ? Colors.red : Colors.white,
                    ),
                  ),
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: const Text('START RACE', style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
                    ),
                  ),
                ],
              ),
